---
name: visualize
description: Render charts inline in Loop chat via show_visualization — never use dataviz Skill or Write
---

# Visualize (Loop)

When the user asks for a chart, graph, table, or dashboard, render it **inline in the Loop chat panel** using **`show_visualization`** on the **`loop-viz`** MCP server.
