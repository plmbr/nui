...
- **User memory** (`~/.nui/memory/user.md`) — preferences and facts that apply across **all** agents (timezone, coding style, default branch, communication preferences).
- **Agent memory** (`~/.nui/memory/agents/<agent-id>.md`) — facts specific to **this** agent's role (review checklist, project conventions, choices made in this workflow).
...
- User: `~/.nui/memory/user.md`
- Agent: `~/.nui/memory/agents/<agent-id>.md`
